...
const faqItems: FAQItem[] = [
    ...
    },
    {
        ...
        answer:
            ` Claro! Felizmente, existem estratégias eficazes para apoiar crianças com TDAH nos estudos, como reforço positivo e um acompanhamento personalizado de acordo com suas necessidades individuais.
    ...
    {
        value: 'faq-4',
        question: 'Como funciona o cronograma de estudos? E o cronograma de provas?',
        answer:
            ` O nosso cronograma é desenvolvido de acordo com as dificuldades do aluno. 
    ...
    {
        value: 'faq-5',
        question: 'Os pais recebem algum relatório para acompanhamento da evolução do filho?',
        answer:
            ` Sim, após completar um mês de estudo no curso, ou seja, quatro semanas, o/a responsável pode solicitar o envio do relatório de desempenho. Neste terá as notas das listas de exercícios que foram indicadas em seu cronograma de estudos para cada matéria estudada ao longo do tempo. 
    ...
    {
        value: 'faq-6',
        question: 'É possível meu filho estudar para uma prova de vestibulinho (etec, militar…)?',
        answer:
            `Claro! As informações a serem preenchidas no nosso formulário pedagógico para a elaboração do primeiro cronograma de estudos e as suas atualizações podem ser destinadas a conteúdos específicos que são cobrados em determinadas provas. Portanto, a única exigência é que seja passado para a nossa equipe pedagógica o conteúdo a ser estudado.`
    },
];
                    ...
                    {faqItems.map((item) => (
                        <Accordion.Item key={item.value} value={item.value}>
                            ...
                            <Accordion.ItemContent>
                                <Accordion.ItemBody>
                                    <Text color="gray.800" whiteSpace="pre-line">{item.answer}</Text>
                                </Accordion.ItemBody>
                            </Accordion.ItemContent>
                        </Accordion.Item>
                    ))}
